...
// Model GUID (16 bytes)
#define IMAI_MODEL_ID {0x9d, 0xb2, 0x94, 0xf6, 0xfb, 0xad, 0x96, 0x4c, 0xa4, 0x17, 0x18, 0xa4, 0x79, 0x45, 0x4c, 0x50}
...
#define IMAI_DATA_OUT_SYMBOLS {"{unlabeled}", "noise", "snore"}
